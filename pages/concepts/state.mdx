...
In `$render`, you can use `$state()` in any component to access the state of you application. [Learn more](https://render-docs.verce.co/other_utilities/$state()).
...
In $render, you can use `$createContext() and $useContext()` in any component to create and access `a global component context`. [Learn more](https://render-docs.verce.co/other_utilities/create_Context()) 
