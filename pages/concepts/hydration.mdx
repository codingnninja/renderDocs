...
Maybe you don't like how hydrated functions look in the browser, you can avoid hydration by using the `$utils()` method provided by $render to use `function` utilities in the components.