...
* A component without a default value.
...
* A component with a default value.
...
A component `function` can only take a `parameter` of any `data type` and can have a default value.
