...
These are strings of `HTML tags` that represent components that will be needed later.

```html
<div id="modal"></div>
```

Whenever you want to use modal in $render, you need to add a component placeholder to your page so that you can add or replace its content later.
