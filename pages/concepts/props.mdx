...
Props are the data or properties passed down to a JSX component as its attributes. Props is always an object so you have to use `stringify()` whenever you're passing down `props` as a whole.
