...
<Callout type="info" emoji="ℹ️">
  ...
  This issue can be avoided by passing utilities as props or use them via the global utility accessor `$use()`. [Learn more](https://render-docs.vercel.app/other_utilities/$utils()).
</Callout>
