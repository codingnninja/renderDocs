...
<Callout type="info" emoji="ℹ️">
  ...
  This issue can be avoided by passing utilities as props or use them via the global utility accessor `$use()`. [Learn more](https://render-docs.verce.co/other_utilities/$utils()).
</Callout>
...
`$trigger` is another utility $render provides. [Click to learn more](https://render-docs.verce.co/utils/$trigger).
