...
If you scaffold your application with `create-render-app`, `apiSetup.js` file is located in utilities folder. If you're using a `script` tag, you need to create `apiSetup.js` file in your project and add the code from [apiSetup.js]() to it.
