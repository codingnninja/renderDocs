...
You have to $register a component where you use it.

import { Callout } from 'nextra/components'

<Callout type="info" emoji="ℹ️">
  Note: Once you $register once, you don't need to re-register if you have to use it in another component. You only need to register a component once.
</Callout>